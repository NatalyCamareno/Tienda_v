...
public class FirebaseStorageService {
    ...
    final String BucketName ="\"project_id\": \"tecshop-67744\".firebasestorage.app";
    ...
    final String archivoJsonFile = "tecshop-67744-firebase-adminsdk-fbsvc-cd920de84d" + ".json";
